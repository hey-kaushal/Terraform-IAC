...
resource "aws_eks_cluster" "capstone" {
  ...
  depends_on = [
    aws_iam_role_policy_attachment.capstone_cluster_role_policy
  ]
}
...
resource "aws_eks_node_group" "capstone" {
  ...
  depends_on = [
    aws_iam_role_policy_attachment.capstone_node_group_role_policy,
    aws_iam_role_policy_attachment.capstone_node_group_cni_policy,
    aws_iam_role_policy_attachment.capstone_node_group_registry_policy,
    aws_iam_role_policy_attachment.capstone_node_group_ebs_policy
  ]
}
